...
const ValidatorRow = (props) => {
    ...
    return <Card body>
        <Row className="validator-info">
            ...
            <Col className="league data" xs={2} md={1}><Link to={"/leagues"}><span className="d-md-inline">League{props.league}</span></Link></Col>
            ...
            {(!props.inactive)?<Col className="commission data" xs={{size:4}} md={{size:1,offset:0}} lg={2}><i className="material-icons d-md-none">call_split</i> <span>{numbro(props.validator.commission.rate).format('0.00%')}</span></Col>:''}
